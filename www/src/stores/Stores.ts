...
export class Job {
  ...
  static fromJSON(json: any) {
    ...
    job.ctcVersion = json.ctcVersion || "8.0";
  ...
  static codecs = {
    ...
    "svt-av1": "AV1 (SVT-AV1)",
    "svt-av1-ra": "AV1 (SVT-AV1) 1-Pass AOM-CTC Random Access (RA)",
    "svt-av1-ra-crf": "AV1 (SVT-AV1) 1-Pass CRF Random Access (RA)",
    "svt-av1-ra-vbr": "AV1 (SVT-AV1) 1-Pass VBR Random Access (RA)",
    "svt-av1-ra-vbr-2p": "AV1 (SVT-AV1) 2-Pass VBR Random Access (RA)",
