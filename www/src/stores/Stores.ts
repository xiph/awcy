...
export class Job {
  ...
  static codecs = {
    ...
    "av1": "libaom (High Latency CQP)",
    "av1-rt": "libaom (Low Latency CQP)",
    "thor": "Thor",
...
export class AppStore {
  ...
  static loadBDRateReport(a: Job, b: Job, set: string, method = "report-overlap", range="av1"): Promise<BDRateReport> {
    let args = [
