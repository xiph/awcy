...
cd rd_tool
DAALA_ROOT=../daala python3 -u rd_tool.py -machines "$NUM_MACHINES" -awsgroup "$SCALING_GROUP" -codec $CODEC $QUALITY_OPTS -prefix "../runs/$2/$3" -runid "$RUN_ID" -bindir "../runs/$2/x86_64" "$3"
